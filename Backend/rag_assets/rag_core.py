...
settings=Settings()
CHROMA_DIR, CHROMA_COLLECTION, DEFAULT_TOP_K, PROMPT_TEMPLATE = settings.CHROMA_DIR, settings.CHROMA_COLLECTION, settings.DEFAULT_TOP_K, settings.PROMPT_TEMPLATE
